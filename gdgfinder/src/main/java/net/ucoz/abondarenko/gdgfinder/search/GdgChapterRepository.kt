...
import net.ucoz.abondarenko.gdgfinder.network.GdgApiService
import net.ucoz.abondarenko.gdgfinder.network.GdgChapter
import net.ucoz.abondarenko.gdgfinder.network.GdgResponse
import net.ucoz.abondarenko.gdgfinder.network.LatLong
